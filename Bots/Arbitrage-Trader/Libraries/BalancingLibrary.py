...
class BalancingLibrary(object):
    ...
    def rebalance(arbitrage_tuple):
		...
		quantity_base = arbitrage_tuple[1]
		quantity_quote = arbitrage_tuple[2]
		sell_exchange = arbitrage_tuple[3]
    ...
    # DESCRIPTION: 
    #	Withdraw wrapper specifically for balancing.
	# NOTE: Possibly not necessary
