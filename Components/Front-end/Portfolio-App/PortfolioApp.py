...
class MainScreen(Screen):
    ...
    # Gridlayout populated with buttons that move to other screens
...
class MiningScreen(Screen):
    ...
    # DESCRIPTION:
    #   Function responsible for initializing the static variables.
    def initializeStaticVariables(self):
        ...
        worker_one_name = "NV1-1"
        worker_two_name = "NV2-2"
        worker_three_name = "AMD1-3"
        worker_four_name = "AMD2-4"
        worker_five_name = "AMD3-5"
        worker_six_name = "AMD4-6"
        worker_seven_name = "AMD5-7"
    ...
    # DESCRIPTION:
    #   Responsible for updating the dynamic worker values.
    def updateWorker():
    ...
    # DESCRIPTION:
    #   Responsible for updating dynamic global values.
    def updateGlobals():
